                    ...
                    <b-col lg="4">
                        <div class="card" style="width: 100%;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">Preis: <b>1.99€ / 30 Tage</b></li>
                    ...
                    <b-col lg="4">
                         <div class="card" style="width: 100%;">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <center><iframe ref="console" src="https://prox.local.shadehost.eu:8006/?console=kvm&novnc=1&vmid=144&node=pve&cmd=" width="100%" height="600"></iframe></center>
                                </tab>
...
export default {
  components: { Tabs, Tab, DashboardStats,
    ...
    mounted: function() {
        ...
        xhr.open('GET', 'https://prox.local.shadehost.eu:8006/?console=kvm&novnc=1&vmid=144&node=pve&cmd=');
